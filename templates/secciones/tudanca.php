<section>
    <div id="link-PDF-razas-container">
        <a id="link-PDF-razas" href="http://meatdairy.esy.es/documentsProject/index.php/api/GenerarPDF?raza=4" target="_blank">Descargar toda la información</a>
    </div>
    <ul id="product-list" >
...
$(document).ready(function(response) {
    $.ajax({
            url: "http://meatdairy.esy.es/documentsProject/index.php/api/obtieneGanado?raza=4", // URL del recurso
            type: "GET", 
            dataType: "json",
            success: function(response) {
                ...
                if (response.success == true) {
                    ...
                    $.each(response.ganados, function(index, ganado) { // function(Index,ganado)
                        ...
                        codigo += '<a class="fancybox" rel="gallery1" href="images/imagenesProductos/Ganado/tudanca/'+ganado.foto+'" title="">';
                        codigo += '<img src="images/imagenesProductos/Ganado/tudanca/'+ganado.foto+'">';
                        codigo += '</a>';          
